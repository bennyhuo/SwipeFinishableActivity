 ...
 */
public class SingleInstanceActivity extends Activity implements SwipeFinishableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SingleInstanceActivity.this, DetailActivity.class);
